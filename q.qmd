...
def server(input, output, session):
    ...
    @render.text
    async def info1():
        return f"Choisir un polluant pour observer les départements d'Occitanie en dégradé de couleurs, ordonnés par maximum du pic de pollution. Cliquer sur un marqueur pour observer une ville en particulier."
