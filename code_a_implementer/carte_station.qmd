...
# Extract 'geometry' and 'attribute' into a list of tuples
combined_data = [(record['geometry'], record['attributes']) for record in recordss]
...
# Drop the original 'geometry' and 'attribute' columns
df_combined = df_combined.drop(['geometry', 'attribute'], axis=1)
