...
---
>>>>>>> 15e62d3fb2e9b69117dc957d065aa6f1851bb151

# Intégration et déploiement

## Le flot de donnée

   * La proposition : Communiqué avec des bases de donné et executer du codes python depuis une page web statiques déployer sur github

## Le flot de donnée
   * La proposition : Communiqué avec des bases de donné et executer du codes python depuis une page web statiques déployer sur github

   * Objectif : Etablir un flot de donnée entre les bases de donnée et une Ghitube page
...
## Le flot de donnée
   ...
   * Enjeux : page web hébergé sur un serveur statiques, contraintes techniques


## ShinyLive

   * Solution qui respecte les contraintes du projet : Documenter et supporter comme extension de quarto
...
## ShinyLive
   ...
   * Permet une interractivité totale entre les modules
